...
class ZipcodesControllerTest < ActionController::TestCase
  ...
  test "should create zipcode" do
    assert_difference('Zipcode.count') do
      post :create, zipcode: { county_id: @zipcode.county_id, zipcode: @zipcode.zipcode, zipcode_id: @zipcode.zipcode_id }
    end
  ...
  test "should update zipcode" do
    patch :update, id: @zipcode, zipcode: { county_id: @zipcode.county_id, zipcode: @zipcode.zipcode, zipcode_id: @zipcode.zipcode_id }
    assert_redirected_to zipcode_path(assigns(:zipcode))
  end
